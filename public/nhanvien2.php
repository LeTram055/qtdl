...
<div class="container">
    <div class="row mb-3">
        <div class="col d-flex justify-content-center ">
            <form class="d-flex align-items-center" method="GET" action="/nhanvien2.php" class="w-100">
                <input class="m-2" type="search" placeholder="Nhập tên nhân viên hoặc mã nhân viên" aria-label="search"
    ...
    <div class="row mb-3">
        <div class="col-6">
            <a href="/them_nhanvien2.php" class="btn btn-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            <a href="<?= 'sua_nhanvien2.php?maNV=' . $row['maNV'] ?>"
                                class="btn btn-xs btn-warning mr-1">
                                Sửa</a>
                            <div style="width: 10px;"></div>
                            <form class="form-inline ml-1" action="/xoa_nhanvien2.php" method="POST">
                                <input type="hidden" name="maNV" value="<?= $row['maNV'] ?>">
                                <button id="delete-sach-btn" type="button" class="btn btn-xs btn-danger  delete-btn"
                                    data-toggle="modal" name="delete-nhanvien" data-target="#delete-confirm">
                                    Xóa
                                </button>
                            </form>
                        </td>
